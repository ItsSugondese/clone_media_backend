...
import (
	...
	tempAttachmentRoute "clone_media/internal/temporary-attachments/route"
	...
	"clone_media/pkg/middleware"
	audit_middleware "clone_media/pkg/middleware/audit-middleware"
	cors_middleware "clone_media/pkg/middleware/cors-middleware"
	lang_middleware "clone_media/pkg/middleware/lang-middleware"
